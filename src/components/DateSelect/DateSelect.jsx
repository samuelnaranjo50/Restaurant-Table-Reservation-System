...
export default function DateSelect (){
    ...
    <div className={styles.ComponentContainer}>
        ...
        <div className={styles.FieldContainer}>
            ...
            <select id="time"  className={styles.InputFieldTrigger} onChange={(e)=>{reservationDispatch({type: 'element-change', field: e.target.id, value: e.target.value})}} onBlur={(e)=>{reservationDispatch({type: 'element-blur', field: e.target.id, value: e.target.value})}}>

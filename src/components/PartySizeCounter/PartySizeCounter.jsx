    ...
    return(
        ...
        <div className={styles.ComponentContainer}>
            ...
            <div className={styles.partyCounter}>
                ...
                <input id="partySize" required type="number" list="seats-number" min="0" max={maxParty} value={reservationState.partySize.value} onChange={(e)=>{reservationDispatch({type: 'element-change', field: e.target.id, value: e.target.value})}} onBlur={(e)=>{reservationDispatch({type: 'element-blur', field: e.target.id,  value: e.target.value})}}/>
